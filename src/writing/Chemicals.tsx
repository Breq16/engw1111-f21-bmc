...
export default function Chemicals() {
  return (
    <article className="pt-64 pb-96 bg-red-500">
      ...
      <p className="max-w-5xl mx-auto font-body">
        ...
        <Indent>
          ...
          <Indent>
            ...
            calling, faster, faster, faster, just me, and nobody else, nobody to
            interfere, nothing to stop me, alone with myself and all the
        ...
        <Indent>
          ...
          <Indent>
            A fear of places, even ones where I know I'll have friends, because
            I know I just won't be able to shake that feeling, the feeling of
            being separated from the world, like a hologram, visible and audible
            only in the most literal sense of the words, and as soon as anyone
            looked closer, they'd find out I'm not really there...
          </Indent>
        </Indent>
        ...
        <Indent>
          ...
          <Indent>
            A fear of being alone, alone with just me and my thoughts, thinking
            about the questions that keep reappearing in my brain, do I want to
            keep living? do I deserve to live? do I think that life is
            worthwhile?, and struggling to find the answers, laying awake, my
            thoughts racing, my body exhausted but unable to rest...
          </Indent>
        </Indent>
      ...
      <DM date="Wednesday, January 22, 2020, 2:17 AM">
        yeah sometime soon - but NOT when i'm tempted to use them - i'm going to
        go through my room and get rid of sharp tools and shit, cuz it's clear i
        can't trust myself alone at this point
      </DM>
      ...
      <DM date="Sunday, October 18, 2020, 2:37 AM">
        ...
        and "kinky" but when I cut myself at 3 am while crying into my pillow I
        "need help" and am a "suicide risk"
      </DM>
      ...
      <p className="font-body max-w-5xl mx-auto text-lg">
        ...
        <Indent>
          ...
          tired to distract myself with the hard questions. Reasoning: If I can
          cover my walls with medals and certificates from things I've done,
          I'll have a sense of who I am. Reasoning: If I spend my life rushing
          from place to place, from responsibility to responsibility, I won't
          find myself lingering outside of my comfort zone.
        </Indent>
        <br />
      </p>
      <blockquote className="max-w-sm text-sm border-2 border-black p-4 mx-auto font-body italic">
      ...
      <div className="max-w-3xl mx-auto font-body text-lg flex flex-col gap-8">
        <p>
          So there's this video game I play sometimes. It's called Celeste. The
          main character, Madeline, is trying to climb a mountain. It’s what you
          might call a ‘platformer’ game--you have to get Madeline from platform
          to platform, jumping and dashing through the air. And it’s famously
          hard, requiring precise timing of just the right button inputs.
        </p>
        <p>
          Just as Madeline isn’t a mountain climber, I’m not much of a gamer. My
          hand-eye coordination is abysmal, and my ability to make split-second
          decisions isn’t great either. It took me months, attempt after
          attempt, sometimes grinding for hours just to get past a single screen
          of a level, but eventually, I made it to the summit.
        </p>
        <p>
      ...
      <DM date="Saturday, October 10, 2020, 4:06 AM">
        ...
        <p>
          ...
          parents are super judge-y about it and probably aren't very supportive
        </p>
        <p>
        ...
        <p>
          3. i continue to do nothing, and nothing really changes except I risk
          possibly ending up in the psych ward (and i probably risk my mom
          deciding that i have depression anyway, leading my down one of the
          same paths as #2)
        </p>
        <p>
          4. i kill myself before any of the above has a chance to happen - this
          one seems pretty appealing ngl, and it would probably be a no-brainer
          if it wasn't for the fact that my recent cutting has started boosting
          my mood and i'm not as impulsively suicidal anymore
        </p>
        <p>
        ...
        <p>6. it would require me to come out as trans, which, uh, haha NOPE</p>
        <p>
      ...
      <DM date="Friday, March 6, 2020, 9:33 PM">
        i feel like i have too many masculine traits (not just physical but also
        like mannerisms and stuff) and i'd either never be able to pass as
        female or i'd kill myself from the stress of trying, and most likely the
        latter
      </DM>
      <div className="max-w-5xl mx-auto text-lg font-body flex flex-col gap-4">
        ...
        <p>
          ...
          deep-voiced and awkward to be a girl.
        </p>
        <p>
          It's not that I need to learn everything about myself all over again,
        ...
        <p>
          ...
          people? do I know if they'll be supportive? do I know if I'll have the
      ...
      <div className="max-w-3xl mx-auto font-body text-xl flex flex-col gap-8">
        <p>
          I started taking antidepressants on January 9, 2021. And they helped.
        </p>
        <p>
