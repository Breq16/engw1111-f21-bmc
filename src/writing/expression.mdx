...
moment: (mathematics) An infinitesimal change in a varying quantity; an increment or decrement.
...
spill: (nautical) To relieve a sail from the pressure of the wind, so that it can be more easily reefed or furled, or to lessen the strain.
wave: (transitive) To cause to move back and forth repeatedly. The starter waved the flag to begin the race.
...
write: (transitive) To be the author of (a book, article, poem, etc.). My uncle writes newspaper articles for The Herald.
...
spring: (intransitive, usually with "to" or "up") To rise suddenly, (of tears) to well up. The documentary made tears spring to their eyes.
...
story: A lie, fiction. Synonyms: see Thesaurus:lie You’ve been telling stories again, haven’t you?
book: (sports) A document, held by the referee, of the incidents happened in the game.
poetry: (figuratively) An artistic quality that appeals to or evokes the emotions, in any medium; something having such a quality. That 'Swan Lake' choreography is poetry in motion, fitting the musical poetry of Tchaikovski's divine score well beyond the literary inspiration.
